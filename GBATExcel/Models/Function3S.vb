...
Class Function3S
    ...
    Public Sub PopulateExcel()
        ...
        System.Web.HttpContext.Current.Session("3SErrors") = Errors
...
#Region "3S Data"
        ...
        For index = 0 To 349
            ...
            For k = 0 To selectedCols.Count - 1
                ...
                If selectedCols(k) = "Cross Street Count" Then
                    oxw.WriteStartElement(Cell, oxa)
                    oxw.WriteElement(New CellValue(mywa2f3s.xstr_list(index).xstr_cnt))
                    oxw.WriteEndElement()
                End If
                ...
                If selectedCols(k) = "Node ID" Then
                    oxw.WriteStartElement(Cell, oxa)
                    oxw.WriteElement(New CellValue(mywa2f3s.xstr_list(index).node_num))
                    oxw.WriteEndElement()
                End If
            Next
