    ...
    Public Sub PopulateExcel()
        ...
        For index = 0 To UserInputs("Borough").Count - 1
            ...
            For Each col As KeyValuePair(Of String, ArrayList) In UserInputs
                ...
                ElseIf col.Key = "Block" Then
                    mywa1.in_bbl.block = col.Value(index)
                ElseIf col.Key = "Lot" Then
                    mywa1.in_bbl.lot = col.Value(index)
                End If
...
#Region "Right Column"
        ...
        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue("RPAD Irreg. Shaped Lot"))
        oxw.WriteEndElement()
        ...
        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue("Tax Section"))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue("Tax Volume"))
        oxw.WriteEndElement()
...
#Region "Left Column"
        ...
        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa2f1a.bbl.block))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa2f1a.bbl.lot))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa2f1a.bbl.BBLToString))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa2f1a.num_of_blockfaces))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa2f1a.sanborn.boro))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa2f1a.sanborn.volume + mywa2f1a.sanborn.volume_suffix))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa2f1a.sanborn.page + mywa2f1a.sanborn.page_suffix))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa2f1a.x_coord))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa2f1a.y_coord))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa2f1a.latitude))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa2f1a.longitude))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa2f1a.vacant_flag))
        oxw.WriteEndElement()

        If mywa2f1a.condo_flag = "C" Then
            oxw.WriteStartElement(Cell, oxa)
            oxw.WriteElement(New CellValue(mywa2f1a.condo_lo_bbl.boro + " - " + mywa2f1a.condo_lo_bbl.block + " - " + mywa2f1a.condo_lo_bbl.lot))
            oxw.WriteEndElement()

            oxw.WriteStartElement(Cell, oxa)
            oxw.WriteElement(New CellValue(mywa2f1a.condo_hi_bbl.boro + " - " + mywa2f1a.condo_hi_bbl.block + " - " + mywa2f1a.condo_hi_bbl.lot))
            oxw.WriteEndElement()
        Else
            oxw.WriteStartElement(Cell, oxa)
        ...
        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa2f1a.bin.BINToString()))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa2f1a.TPAD_new_bin.ToString()))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa2f1a.corner_code))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa2f1a.num_of_bldgs))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa2f1a.bid_id.B5scToString().Trim()))
        oxw.WriteEndElement()

        If String.IsNullOrEmpty(mywa2f1a.bid_id.B5scToString().Trim()) Then
        ...
        Else
            ...
            oxw.WriteStartElement(Cell, oxa)
            oxw.WriteElement(New CellValue(GetStreetName(mywa2f1a.bid_id.boro, mywa2f1a.bid_id.B5scToString().Remove(0, 1))))
            oxw.WriteEndElement()
...
#Region "Right Column"
        ...
        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa2f1a.rpad_scc))
        oxw.WriteEndElement()

        If String.IsNullOrEmpty(mywa2f1a.interior_flag) Then
        ...
        Else
            ...
            oxw.WriteStartElement(Cell, oxa)
            oxw.WriteElement(New CellValue(mywa2f1a.interior_flag))
            oxw.WriteEndElement()

        End If

        If String.IsNullOrEmpty(mywa2f1a.irreg_flag) Then
        ...
        Else
            ...
            oxw.WriteStartElement(Cell, oxa)
            oxw.WriteElement(New CellValue(mywa2f1a.irreg_flag))
            oxw.WriteEndElement()

        End If

        If String.IsNullOrEmpty(mywa2f1a.condo_num) Or (mywa2f1a.condo_num) = "0" Then
        ...
        Else
            ...
            oxw.WriteStartElement(Cell, oxa)
            oxw.WriteElement(New CellValue(mywa2f1a.condo_num))
            oxw.WriteEndElement()

        End If

        If String.IsNullOrEmpty(mywa2f1a.coop_num) Or (mywa2f1a.coop_num) = "0" Then
        ...
        Else
            ...
            oxw.WriteStartElement(Cell, oxa)
            oxw.WriteElement(New CellValue(mywa2f1a.coop_num))
            oxw.WriteEndElement()

        End If

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa2f1a.condo_flag))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa2f1a.dof_map.boro))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa2f1a.dof_map.section_volume.Remove(2, 2)))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa2f1a.dof_map.section_volume.Remove(0, 2)))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa2f1a.TPAD_bin_status))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa2f1a.TPAD_new_bin_status))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa2f1a.TPAD_conflict_flag))
        oxw.WriteEndElement()
#End Region
    ...
    Public Function PopulateHeadingError(oxw As OpenXmlWriter, workSheetPart As WorksheetPart)
        ...
        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue("Block"))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue("Lot"))
        oxw.WriteEndElement()
    ...
    Sub PopulateExcelError(oxw As OpenXmlWriter, mywa1 As Wa1, id As Integer)
        ...
        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa1.in_bbl.block))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa1.in_bbl.lot))
        oxw.WriteEndElement()
