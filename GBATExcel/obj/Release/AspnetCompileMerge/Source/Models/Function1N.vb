    ...
    Public Sub PopulateExcel()
        ...
        For index = 0 To UserInputs("Borough").Count - 1
            ...
            For Each col As KeyValuePair(Of String, ArrayList) In UserInputs
                ...
                ElseIf col.Key = "Street Name" Then
                    mywa1.in_stname1 = col.Value(index)
                End If

            Next

            mywa1.in_func_code = "1N"
...
#Region "Manual Call Without User Selection"
    ...
    Function PopulateExcelDataHeadingManual(oxw As OpenXmlWriter, workSheetPart As WorksheetPart)
        ...
        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue("Borough"))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue("B10SC"))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue("Street Name"))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue("Geographic Feature Type"))
        oxw.WriteEndElement()
...
#Region "Street Information"
        ...
        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa1.out_boro_name1))
        oxw.WriteEndElement()
        ...
        If Not mywa1.out_attr_bytes(0) = "M" Then
            oxw.WriteStartElement(Cell, oxa)
            oxw.WriteElement(New CellValue("Unhyphenated"))
            oxw.WriteEndElement()
        Else
            oxw.WriteStartElement(Cell, oxa)
            oxw.WriteElement(New CellValue("Mixed Hyphenated"))
            oxw.WriteEndElement()
        End If
...
#End Region
    ...
    Public Function PopulateHeadingError(oxw As OpenXmlWriter, workSheetPart As WorksheetPart)
        ...
        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue("Street"))
        oxw.WriteEndElement()
...
#End Region
    ...
    Function PopulateGeoXDictionary(mywa1 As Wa1)

        Dim allValuesForSelectedFields As New Dictionary(Of String, String)

        'Street Information
        allValuesForSelectedFields.Add("Borough", mywa1.out_boro_name1)
        allValuesForSelectedFields.Add("B10SC", mywa1.out_b10sc1.B10scToString)
        allValuesForSelectedFields.Add("Street Name", mywa1.out_stname1)
        If Not mywa1.out_attr_bytes(0) = "M" Then
            allValuesForSelectedFields.Add("Geographic Feature Type", "Unhyphenated")
        Else
            allValuesForSelectedFields.Add("Geographic Feature Type", "Mixed Hyphenated")
        End If
