...
Class FunctionDG
    ...
    Public Sub PopulateExcel()
        ...
        For index = 0 To UserInputs("Street Code").Count - 1
            mywa1.Clear()

            For Each col As KeyValuePair(Of String, ArrayList) In UserInputs
                If Not IsDBNull(col.Value(index)) Then
                    If col.Key = "Street Code" Then
                        mywa1.in_b10sc1.B10scFromString(col.Value(index))
                    End If
                End If
            Next
    ...
    Function PopulateExcelDataHeadingManual(oxw As OpenXmlWriter, workSheetPart As WorksheetPart)
        ...
        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue("B10SC1"))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue("Street Name1"))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue("Street Name2"))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue("Street Name3"))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue("Geographic Feature Type 1"))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue("Geographic Feature Type 2"))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue("Geographic Feature Type 3"))
        oxw.WriteEndElement()
    ...
    Sub PopulateExcelDataManual(id As Integer, oxw As OpenXmlWriter, index As Integer)
        ...
        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa1.out_stname2))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa1.out_stname3))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa1.out_attr_bytes(0).ToString))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa1.out_attr_bytes(1).ToString))
        oxw.WriteEndElement()

        oxw.WriteStartElement(Cell, oxa)
        oxw.WriteElement(New CellValue(mywa1.out_attr_bytes(2).ToString))
        oxw.WriteEndElement()
    ...
    Sub PopulateExcelError(oxw As OpenXmlWriter, mywa1 As Wa1, id As Integer)
        ...
        iDCell.DataType = CellValues.Number
        oxw.WriteStartElement(iDCell)
        oxw.WriteElement(New CellValue(outputIdCounter))
        oxw.WriteEndElement()
